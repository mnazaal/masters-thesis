...
#@ex2.automain
def synthetic_dag_binarydata_experiment_1(nodes, p_edge,n):
    ...
    #assert set(ordering)==set(list(val_dict.keys()))
        try:
            ...
            cstree_object.visualize(plot_mcdags=True,ordering=ordering, use_dag=False, save_dir="synthetic-empirical"+str(i))
...
synthetic_dag_binarydata_experiment_1(5, 0.4, 100000)
