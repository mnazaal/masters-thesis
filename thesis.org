...
** Synthetic data
    ...
    # [!!! TODO Put learnt CSTrees and DAGs]

    # [!!! TODO Put table with statistics for changing $p$ etc]
...
** Discussion of empirical performance
   ...
   - The staging can be highly sensitive to the independence testing being done. We use the Epps and Singleton test cite:epps-1986-omnib-test,goerg-2009-nonpar-testin and the  Anderson-Darling test cite:scholz-1987-k-sampl.
