...
{{{marginfigure( width=\linewidth, ./figures/dageg, Example of a DAG.)}}}
...
# !!! TODO LIam suggest on probability simplex as the space over which each joint distribution resides over.
...
#  - DAG to CSTree conversion for empty graph, fully connected DAG
