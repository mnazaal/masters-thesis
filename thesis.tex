...
\label{sec:org2e1b2fb}
\section{The Causal Discovery problem}
\label{sec:orgd772002}
...
\end{table*}
 \newpage 
   Table \ref{tab:orgba320f2} shows the results of experimental setup 3 on the Vitamin D dataset.

\begin{table}[htbp]
\caption{\label{tab:orgba320f2}Experimental setup 3 on Vitamin D dataset with ordering 53421}
\centering
\begin{tabular}{l|l|r|r}
\hline
Model & Algorithm & BIC & Stages\\
