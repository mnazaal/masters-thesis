...
\label{sec:org4291655}
\label{sec:Intro}
\section{Motivation}
\label{sec:orgfb29313}
...
\end{definition}
 ...
 \begin{marginfigure} \includegraphics[width=\linewidth]{ ./figures/dageg.pdf}\caption{ Example of a DAG.} \end{marginfigure} 
...
\chapter{Experiments}
\label{sec:org5b3fadb}
\section{Encoding DAGs as CSTrees}
\label{sec:orgc4237da}
...
\chapter{Appendix A}
\label{sec:org329119a}
\section{Remarks on implementation}
\label{sec:org81ddc17}
