...
\label{sec:orgcfde70e}
\label{sec:Intro}
\section{Motivation}
\label{sec:org8da8014}
...
\chapter{Experiments}
\label{sec:org518a782}
\section{Encoding DAGs as CSTrees}
\label{sec:org8bb5410}
...
\chapter{Conclusions}
\label{sec:orgdb84672}
\section{Summary}
\label{sec:org9d9fbb3}


\section{Future work}
\label{sec:org730c3d1}
...
\chapter{Appendix A}
\label{sec:org47c1c02}
\section{Remarks on implementation}
\label{sec:orgd4fb398}
Implementation of this work was done in Python. Draft code repository is available at github.com/mnazaal/masters-thesis. This document was generated with org-mode. Use of scikit, pandas, numpy
\end{document}