...
\label{sec:org7487f1f}
\label{sec:Intro}
\section{Motivation}
\label{sec:org1ae96a2}
...
\chapter{Experiments}
\label{sec:org63a5f7b}
\section{Encoding DAGs as CSTrees}
\label{sec:orgb74550c}
...
\chapter{Conclusions}
\label{sec:orge89902a}
\section{Summary}
\label{sec:org0f3f946}
...
\chapter{Appendix A}
\label{sec:orgad1c8bd}
\section{Remarks on implementation}
\label{sec:orgf913bef}
