...
\label{sec:org99504a5}
\section{The Causal Discovery problem}
\label{sec:orge281a7c}
...
\end{table*}
 \newpage 
   Table \ref{tab:orgcc6b967} shows the results of experimental setup 3 on the Vitamin D dataset.

\begin{table}[htbp]
\caption{\label{tab:orgcc6b967}Experimental setup 3 on Vitamin D dataset with ordering 53421}
\centering
\begin{tabular}{l|l|r|r}
\hline
Model & Algorithm & BIC & Stages\\
