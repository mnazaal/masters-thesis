...
\label{sec:org5047bc7}
\section{The Causal Discovery problem}
\label{sec:orgee07c74}
...
\end{table*}
 \newpage 
   Table \ref{tab:org584293d} shows the results of experimental setup 3 on the Vitamin D dataset.

\begin{table}[htbp]
\caption{\label{tab:org584293d}Experimental setup 3 on Vitamin D dataset with ordering 53421}
\centering
\begin{tabular}{l|l|r|r}
\hline
Model & Algorithm & BIC & Stages\\
