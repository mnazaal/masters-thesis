...
\label{sec:org21f793d}
\label{sec:Intro}
\section{Motivation}
\label{sec:org4e284c2}
...
\chapter{Experiments}
\label{sec:org7fba414}
\section{Encoding DAGs as CSTrees}
\label{sec:org56ff1f6}
...
\chapter{Conclusions}
\label{sec:org53d0430}
\section{Summary}
\label{sec:org8df74f2}
...
\chapter{Appendix A}
\label{sec:orgc56ec05}
\section{Remarks on implementation}
\label{sec:org128b8d6}
