...
\label{sec:orgbb5f94d}
\label{sec:Intro}
\section{Motivation}
\label{sec:org6134544}
...
\label{sec:orgc8b5656}
\section{The Causal Discovery problem}
\label{sec:org03499b9}
...
We call this \textbf{experimental setup 3}, and detail the results of it on the coronary dataset below in Table \ref{tab:orgc7e2521}. None of the staged trees learnt by algorithms (1)-(4) above are CStrees, and they are included in the Appendix.

\begin{table}[htbp]
\caption{\label{tab:orgc7e2521}Experimental setup 3 on the coronary dataset}
\centering
...
We now take the recorded ordering which gave the highest BIC score on this dataset (which is 3276514) and perform experimental setup 3. The results are summarized in Table \ref{tab:orgd30dea6}.

\begin{table}[htbp]
\caption{\label{tab:orgd30dea6}Experimental setup 3 on the mice protein expression dataset}
\centering
\begin{tabular}{l|l|r|r}
\hline
Model & Algorithm & BIC & Stages\\
...
\end{table*}
 \newpage 
   Table \ref{tab:orge985266} shows the results of experimental setup 3 on the Vitamin D dataset.

\begin{table}[htbp]
\caption{\label{tab:orge985266}Experimental setup 3 on Vitamin D dataset with ordering 53421}
\centering
\begin{tabular}{l|l|r|r}
\hline
Model & Algorithm & BIC & Stages\\
...
\chapter{Conclusions}
\label{sec:org18bf09c}
\section{Summary}
\label{sec:org878f2f9}
